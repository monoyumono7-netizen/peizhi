...
2. Gathers relevant CODEBUDDY.md guideline files from the repository
3. Summarizes the pull request changes
4. Launches 4 parallel agents to independently review:
   - **Agents #1 & #2**: Audit for CODEBUDDY.md compliance
...
- CODEBUDDY.md compliance checking with explicit guideline verification
...
- General quality issues (unless in CODEBUDDY.md)
- Issues with lint ignore comments

## Installation

This plugin is included in the CodeBuddy Code repository. The command is automatically available when using CodeBuddy Code.

## Best Practices

### Using `/code-review`
- Maintain clear CODEBUDDY.md files for better compliance checking
- Trust the 80+ confidence threshold - false positives are filtered
- Run on all non-trivial pull requests
- Review agent findings as a starting point for human review
- Update CODEBUDDY.md based on recurring review patterns
...
- CODEBUDDY.md files (optional but recommended for guideline checking)
...
- Make CODEBUDDY.md more specific about what matters
...
- **Write specific CODEBUDDY.md files**: Clear guidelines = better reviews
- **Include context in PRs**: Helps agents understand intent
- **Use confidence scores**: Issues ≥80 are usually correct
- **Iterate on guidelines**: Update CODEBUDDY.md based on patterns
...
### Agent architecture
- **2x CODEBUDDY.md compliance agents**: Redundancy for guideline checks
...
- For CODEBUDDY.md issues: verifies guideline explicitly mentions it
